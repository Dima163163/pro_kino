const createListTrailers = (parrent, srcList) => {
  ...
  srcList.forEach(src => {
    ...
    <a href="https://www.youtube.com/embed/${idVideo[1]}?autoplay=1">
      <img src="https://img.youtube.com/vi/${idVideo[1]}/maxresdefault.jpg">
      <div id="button">
